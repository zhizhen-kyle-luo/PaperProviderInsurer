...
This appendix provides the full technical specification of agent action spaces and request/response schemas summarized in Section~\ref{sec:agents}.
...
Our three-level review structure (Section~\ref{sec:levels}) is grounded in the Medicare Fee-for-Service appeals process \citep{cms2024appeals}. Medicare defines five levels of appeal that follow an initial coverage determination:
